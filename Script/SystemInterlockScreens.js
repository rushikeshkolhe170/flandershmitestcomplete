...
// Verify the visibility and mouse event on the system interlock status
...
function SystemInterlockScreens()
{
  ...
  //Check visibility and Clicks the 'ButtonSystemInterlockStatus' button.
  checkVisibilityAndClick(maint_Interlock_Variable.SystemInterlockStatus_Btn, "System Interlock Status");
  if(verifyElementEnabled(maint_Interlock_Variable.DialogueBox)){
    ...
    Log.Error("System Interlock Screen is not available add the XML file in ScreenXMLFile folder");
  } else {
  ...
  //Check visibility and Clicks the 'ButtonFeedInterlockStatus' button.
  checkVisibilityAndClick(maint_Interlock_Variable.FeedInterlockStatus_Btn, "Feed Interlock Status");
  if(verifyElementEnabled(maint_Interlock_Variable.DialogueBox)){
    maint_Interlock_Variable.DialogueOK_Btn.ClickButton();
    //Throw the error because by default this file gets available in the folder
    Log.Error("Feed Interlock Screen is not available add the XML file in ScreenXMLFile folder");
  } else {
    //Rotates the mouse wheel over the 'myDiagram' object.
    aqUtils.Delay(2000);
    mouseScroll(maint_Interlock_Variable.ScreenDiagram, 10);
  ...
  //Check visibility and Clicks the 'ButtonRotaryInterlockStatus' button.
  checkVisibilityAndClick(maint_Interlock_Variable.RotaryInterlockStatus_Btn, "Rotary Interlock Status");
  if(verifyElementEnabled(maint_Interlock_Variable.DialogueBox)){
    maint_Interlock_Variable.DialogueOK_Btn.ClickButton();
    //Throw the error because by default this file gets available in the folder
    Log.Error("Rotary Interlock Screen is not available add the XML file in ScreenXMLFile folder");
  } else {
    //Rotates the mouse wheel over the 'myDiagram' object.
    aqUtils.Delay(2000);
    mouseScroll(maint_Interlock_Variable.ScreenDiagram, 10);
